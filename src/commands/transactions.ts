            ...
            const recreatedTransaction = await client.createTransaction(
              {
                transaction: {
                  ...
                  payee_id: existingTransaction.payee_id ?? undefined,
                  payee_name: existingTransaction.payee_name ?? undefined,
                  category_id: undefined,
                  memo: existingTransaction.memo ?? undefined,
                  cleared: existingTransaction.cleared,
                  approved: existingTransaction.approved,
                  flag_color: existingTransaction.flag_color ?? undefined,
